...
![](figs/parallel_coordinates_%60r%20file_ext%60.png)

# Sensitivity

"To support decision-making, exploratory modelling can help identifying the main factors of change and decision boundaries. Factors of change might include external uncertainties (i.e. factors that cannot be controlled), planning decisions (i.e. factors that can be controlled) and inherent system stochasticity." (Roman et al., 2026)

| External uncertainties | Planning decisions | Inherent system stochasticity |
|----|----|----|
| Improvement of condition upon restoration | Maximum area to restore |  |
|  | Degree of spatial clustering/size of planning unit |  |
